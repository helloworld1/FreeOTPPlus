...
class ScanActivity : Activity(), SurfaceHolder.Callback {
    ...
    init {
        ...
        mScanAsyncTask = object : ScanAsyncTask() {
            override fun onPostExecute(result: String) {
                ...
                val token = TokenPersistence.addWithToast(this@ScanActivity, result)
                ...
                Picasso.with(this@ScanActivity)
                        ...
                        .into(image, object : Callback {
                            override fun onSuccess() {
                                findViewById(R.id.progress).visibility = View.INVISIBLE
                                image.alpha = 0.9f
    ...
    override fun onStart() {
        super.onStart()
        (findViewById(R.id.surfaceview) as SurfaceView).holder.addCallback(this)
    }
    ...
    override fun surfaceCreated(holder: SurfaceHolder) {
        ...
        try {
            ...
            // Show error message
            findViewById(R.id.surfaceview).visibility = View.INVISIBLE
            findViewById(R.id.progress).visibility = View.INVISIBLE
            findViewById(R.id.window).visibility = View.INVISIBLE
