...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            version("androidxJunit", "1.1.3")
            version("androidxTruth", "1.4.0")
            ...
            library("androidxTestOrchestrator","androidx.test", "orchestrator").versionRef("androidxTestCore")
